...
### Общий процесс создания курса

<img src="https://github.com/SerendipityLab/course-development/blob/master/pics/Screen%20Shot%202018-01-24%20at%208.56.58%20PM.png">
...
5. Файлы **заданий**, имя которых включает **ASSIN + номер урока + номер задания** (ASSIN1.1). В файле задания раздела содержится все, необходимое в задании на основе **типовой структуры задания** (см. ниже).
...
* Описание каждого вопроса, включая все версии ответов и оценки.
* Перечень шаблонов, упоминаемых в тесте.
...
2. Заполнение таблицы курса/ уроков/ разделов/ тестов/ вопросов.
3. Загрузка на тестовый сервер, настройка доступов.
4. Отладка, исправление багов, тестирование на всех тарифах.
