...
5. Файлы **заданий**, имя которых включает **ASSIN + номер урока + номер раздела + номер задания**. В файле задания раздела содержится все, необходимое в задании на основе **типовой структуры задания** (см. ниже).
